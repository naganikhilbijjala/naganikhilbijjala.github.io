...
const greeting = {
  ...
  title: "Hi all, I'm Naga Nikhil",
  subTitle: emoji(
    "A passionate Backend Software Developer 🚀 having an experience of building REST APIs with Java / SpringBoot and some other cool libraries and frameworks."
  ),
  resumeLink:
